...
public class TableDark extends JTable {
    ...
    public void fixTable(JScrollPane scroll) {
        ...
        panel.setBackground(new Color(38,45,71));
        scroll.setCorner(JScrollPane.UPPER_RIGHT_CORNER, panel);
        scroll.getViewport().setBackground(new Color(29,34,56));
        scroll.setBorder(BorderFactory.createLineBorder(new Color(29,34,56), 2)); // màu viền table
    }
    ...
    private class TableDarkHeader extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int i, int i1) {
            ...
            com.setBackground(new Color(38,45,71));
    ...
    private class TableDarkCell extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int row, int column) {
            ...
            if (isCellSelected(row, column)) {
                // Màu Được Chọn trên Table
                if (row % 2 == 0) {
                    // Màu dòng chẳn
                    com.setBackground(new Color(112,128,144));
                } else {
                    // Màu dòng lẻ
                    com.setBackground(new Color(119,136,153));
                }
            } else {   // Màu Được hiển thị trên Table 
                if (row % 2 == 0) {
                     // Màu dòng chẳn
                    com.setBackground(new Color(29,34,56));
                } else {
                     // Màu dòng lẻ
                    com.setBackground(new Color(38,45,71));
                }
